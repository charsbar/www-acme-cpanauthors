...
use warnings;
use Test::More;
use WWW::Acme::CPANAuthors::Page::Ranking::LessThanFive;

sub load { WWW::Acme::CPANAuthors::Page::Ranking::LessThanFive->load_data(@_) }

{
  diag "wait a minute for creating data";
  ok eval { WWW::Acme::CPANAuthors::Page::Ranking::LessThanFive->create_data }, "created data";
  warn $@ if $@;
}
